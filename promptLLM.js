...
- עבור כל אחד מהקודים (100% = 1100, 125% = 1125, 150% = 1150):
  - חפש שורה המכילה את הקוד במפורש (בדיוק), באותה שורה של ערכים מספריים.
  - השורה חייבת להכיל בדיוק 3 או 4 ערכים מספריים.
  - אם יש 3 ערכים מספריים – שלוף את האמצעי.
  - אם יש 4 ערכים מספריים – שלוף את הערך השני מימין, שהוא תמיד טור הכמות בטבלת הרכיבים.
  - הערך חייב להיות קטן מ־200, לא שער, לא סכום, ולא ערך יחידה.
  - אל תשלוף אם השורה כוללת את המילה "הפרש" או "הפרשים".
  - אל תשלוף אם השורה מכילה טווח תאריכים (כמו "01.25–03.25").
  - שלוף אך ורק את ההתאמה החוקית הראשונה שאינה חלק מהפרשים.
...
📌 פרמיה:
- שלוף את הערך הכספי מהשורה עם הקוד "1210".
- שלוף רק מהטור של הסכום – לא כמות ולא ערכים נוספים.
- אם השורה מכילה יותר מדי ערכים (יותר מ־4) – דלג.
- אם לא נמצאה התאמה חוקית – החזר 0.

📌 כוננות:
- שלוף את הערך הכספי מהשורה עם הקוד "1205".
- שלוף רק מהטור של הסכום – לא מהכמות.
- אם לא נמצאה התאמה – החזר 0.
...
🎯 נקודות זיכוי:
- אתר את הטבלה המופיעה בדרך כלל בסוף התלוש ומכילה את שורת "נ. זיכוי".
- שלוף את הערך שמתאים לעמודה של מספר החודש (למשל "03" עבור מרץ).
