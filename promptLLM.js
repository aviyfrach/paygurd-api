...
- בעת חילוץ שעות נוספות (1100, 1125, 1150), שלוף אך ורק את **הטור השלישי מימין**, שהוא טור הכמות.
- אל תשתמש בשום ערך אחר מהשורה – גם אם הוא קטן מ־200.
- שלוף רק מהשורה הראשונה התקפה שלא כוללת את המילים "הפרש" או טווח תאריכים.
- ודא שהערך קטן מ־200 ואינו שער, סכום כספי או מקדם.
...
- שלוף רק מהטור של הכמות (השלישי מימין).
